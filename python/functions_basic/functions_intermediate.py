...
# the function prints the value stored in that 
...
# whose values are all lists, prints the name of each key 
# along with the size of its list, and then prints the associated 
...
def print_info(dictionary_item):
    for key in dictionary_item:
        print(str(len(key)) + ' ' + key)
        print(dictionary_item[key])
